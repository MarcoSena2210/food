...
<head>
    ...
    <!-- Essa section renderizará os estilos especificos da view que esteder esse layout/ Definir area especifica que cada view vai precisar -->
...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <!-- breadcrumb/message sucesso -->
                    <?php if (session()->has('sucesso')) : ?>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Mensagem geral topo -->
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <strong>Perfeito!<i class="fas fa-smile-wink"></i>&nbsp;&nbsp;<?php echo session('sucesso'); ?></strong>
                    ...
                    <?php if (session()->has('info')) : ?>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Mensagem geral topo -->
                                <div class="alert alert-info alert-dismissible fade show text-gray-900" role="alert">
                                    <strong>Informação! <i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;<?php echo session('info'); ?></strong>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong>Atenção!<i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;<?php echo session('atencao'); ?></strong>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <!-- Captura os erros de CSRF -A ção não permitida -->
                    <?php if (session()->has('error')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Mensagem geral topo -->
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong>Erro!<i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;<?php echo session('error'); ?></strong>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <!-- Essa section renderizará os conteudos especificos da view que esteder esse layout -->
    ...
    <!-- Essa section renderizará os scripts especificos da view que esteder esse layout -->
